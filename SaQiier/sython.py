...
async def join_channel():
    try:
        await sython(JoinChannelRequest("@B_C_1"))
...
async def _(event):
        ...
        await sython.send_message('@zmmbot, 'جاري تجميع النقاط ... ')
        channel_entity = await sython.get_entity(bot_username)
...
async def _(event):
      await event.reply("""السـورس يعمـل | SaQiier SOURCE
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
...
async def _(event):
      await event.reply("""SY OWNER : @isHSsON"""
)
